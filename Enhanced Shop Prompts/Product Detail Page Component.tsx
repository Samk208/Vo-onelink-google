          ...
          <div className="flex items-center space-x-2">
            {product.shop.influencer.avatar_url && (
              <Image
                ...
                alt={product.shop.influencer.display_name}
                width={24}
                height={24}
            ...
            <span className="font-medium text-gray-900">
              {product.shop.influencer.display_name}
            </span>
          </div>
        </div>
      </div>
        ...
        {hasDiscount && (
          <div className="rounded-lg bg-blue-50 p-4">
            <p className="text-sm text-blue-800">
              <strong>Influencer Exclusive:</strong> Special pricing available only through {product.shop.influencer.display_name}'s shop!
            </p>
          </div>
        )}
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <ProductImageGallery 
            ...
            productName={productData.custom_title || productData.name} 
          />
